...
import { AccumulationTheme, ChartTheme, IAccLoadedEventArgs, IAccPointRenderEventArgs, ILoadedEventArgs } from '@syncfusion/ej2-angular-charts';
...
public pointRender(args: IAccPointRenderEventArgs): void {
  ...
  if(elementBody){
    ...
    console.error('Element with ID "column" not found,');
  }
